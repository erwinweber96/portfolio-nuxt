...
<template>
  <svg
    class="w-5 inline-block my-auto pb-1 ml-2"
    viewBox="0 0 24 24"
    fill="none"
  ...
  >
    ...
    <g id="SVGRepo_iconCarrier">
      <path
        ...
        fill="#ec4899"
      ></path>
      <path d="M8 12H16" stroke="#ec4899" stroke-width="1.5" stroke-linecap="round"></path>
      <path d="M8 15.5H13.5" stroke="#ec4899" stroke-width="1.5" stroke-linecap="round"></path>
      <path
